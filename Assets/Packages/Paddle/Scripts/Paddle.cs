...
public class Paddle
{
    ...
    {
        if (targetVelocitySmooth != null && targetVelocitySmooth != currentVelocity)
            SetSmoothVelocity((float)targetVelocitySmooth, dt);
    ...
    public void SetCurrentVelocity(float value)
    {
        targetVelocitySmooth = null;
